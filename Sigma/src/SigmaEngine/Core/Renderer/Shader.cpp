...
void Shader::setUniform3f(const std::string& name, float f0, float f1, float f2) const  {
	bind();
...
void Shader::setUniformMat4f(const std::string& name, const glm::mat4& mat4) const
{
	bind();
